                        ...
                        <div class="inner_section">
                            <div class="row">
                                <div class=" col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right">
                                    ...
                                    {!! Html::image('assets/img/'.$page->images, '', ['class'=>'img-circle delay-03s animated wow zoomIn', 'alt'=>'']) !!} </div>
                                <div class=" col-lg-7 col-md-7 col-sm-7 col-xs-12 pull-left">
                                    ...
                                    <div class="work_bottom">
                                        <a href="{{ route('page', ['alias'=>$page->alias]) }}" class="contact_btn">Подробнее</a> </div>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-4 wow fadeInLeft">
                    <div class="contact_info">
                        <div class="detail">
                            <h4>Адрес</h4>
                            <p>Россия, г. Пермь, Закамск, ул. Торговая 8</p>
                        </div>
                        <div class="detail">
                            <h4>Телефон</h4>
                            <p>+7 909 727-44-31</p>
